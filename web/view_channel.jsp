<%-- 
    ...
    Created on : 31 Jan, 2023, 10:02:58 AM
    Author     : Rahul
--%>
                        ...
                        <div class="col-sm-2">
                            <div class="row">
                                <div class="col-sm-12 ml-5 mt-2">
                                    <img src="channel_img/<%=channel_code%>.jpg" style="width:100px;height: 100px;border-radius: 50%">
                                </div>
                            </div>      
                        </div>
            ...
            <div class="row ml-5">
                <%
                    try {
                        ...
                        ResultSet rs = st1.executeQuery("select * from video where channel_code='" + channel_code + "'");
...
<!--                                    <div class="row mt-3">
                                        <div class="col-sm-1">
                                            <img src="channel_img/<%=channel_code%>.jpg" style="height:45px;width:45px;border-radius:50%;">
                                        </div>

                                        <div class="col-sm-11" >
                                            <h6>&nbsp;<span class="fa fa-check-circle"></span></h6>
                                        </div>
                                    </div>-->
