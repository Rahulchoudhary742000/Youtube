                          ...
                          <div class="col-sm-12 mt-5 "  >
                             <div class="row card card-body"  style=" box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);border-radius:10px" >
                                 ...
                                 <div class="col-sm-12 card-body "  >
                                     ...
                                     <form method="post" ACTION="video_details.jsp?code=<%=vcode%>" >
                                          
                                           <SMALL>Title</SMALL>
                                           <input type="text" name="title"  class="form-control"required placeholder="Enter Title....">
                                           <br>
                                           <small>Description</small>
                                           <textarea name="description" rows="6"cols="5"required style="resize:none" class="form-control" placeholder="Enter Description"></textarea>
                                           
                                           <button class="btn  mt-3 float-left py-3 " style="background: #B3AEDE;width:40%;color:#fff"><i class="fa fa-upload"></i>&nbsp;&nbsp;<b>Upload</b></button>
                                           <button type="reset"   class="btn float-right mt-3 py-3"  name="Reset"   style="width:40%;color:#fff;background-color:#A5CE7C" ><i class="fa fa-refresh"></i>&nbsp;&nbsp;<b>Reset</b></button>
                                      </form>
                                  </div>
                              </div>
                         </div>
...
<%
                     ...
                     out.println("<h1><center>NO MATCH FOUND</center></h1>");
             }
 }
   else{
