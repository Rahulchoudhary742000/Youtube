                ...
                <div class="col-sm-12">
                    <div class="row ">
                        ...
                        <div class="col-sm-11 card-header bg-secondary text-light mt-5 py-3 px-3" style="border-radius: 5px;  box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);">
                            <center><b class="">Subscription</b></center>
                        </div>
                    </div>
                    <div class="row mt-1 ">
                        <%
                            try {
                                ...
                                Statement st = cn.createStatement();
                                Statement st1 = cn.createStatement();
                                ResultSet rs = st.executeQuery("select * from subscription where user_email='" + email + "' AND status=" + 1 + " ");
                        ...
                        %>
                        <div class="grid  col-sm-6 mt-5" id="channel_<%=rs1.getString("code")%>" >
                            <div class="row">
                                <div class="col-sm-2"></div>
                                <div class="col-sm-10">
                                    <div class="row py-2 px-2"  style="border-radius: 5px">
                                       <div class="col-sm-1">
                                            <span  style=""><img src="channel_img/<%=rs1.getString("code")%>.jpg" style="height:90px;width:90px;border-radius:50%;"></span>
                                        </div>
                                        <div class="col-sm-2"></div>
                                        <div class="col-sm-4 mt-4" >
                                            <h3 ><%=rs1.getString("channel_name")%></h3>
                                        </div>
                                        <div class="col-sm-2 mt-5">
                                            <button class="py-2 Subscribe" rel="<%=rs1.getString("code")%>"style="background-color: #FFFFFF; color:black ; border-radius:30px;font-size:13px; width:100px"><b id="Subscribe">Subscribed</b></button>
                                        </div>
                                        <div class="col-sm-2"></div>
                                        <div class="col-sm-1"></div>
                                    </div>
