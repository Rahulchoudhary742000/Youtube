          ...
          <style>
           ...
           @media (max-width:576px){
                .sidebar{
                 ...
                 .glyphicon.glyphicon-menu-hamburger.text-dark{
                     font-size:14px;
                 }
                 #logo_png{
                     display:none;
     ...
     <nav class=" sticky-top card-body bg-light"   >
               <div class="container-fluid" >
                     <div class="row"style="display:flex">
                         ...
                         <div class="col-sm-2" style="margin-top:8px;width:10%">
                              <img src="yt.png"  style="margin-left: -50px; margin-top:-15px;height:55px" id='logo_png'>
                         </div>
                         
                         <div class="col-sm-5"style="margin-top:4px;width:65%">
                         ...
                         <div class="col-sm-3" style="float:right;width:10%"id="notification_bell">
                             <div class="row">
                  ...
                  <div class="col-sm-1" id='user_profile'style="width:10%">
             ...
             <div class="row  card-body">
                <div class="col-sm-2"></div>
                 <div class="col-sm-8 card-body">
                     <div class="row">
                         <!----<div class="col-sm-12">
                                    <span class="card"  style="cursor:pointer;width:150px;height:150px;border-radius:50%;">
                                        <i class="fa fa-upload"  style="font-size:90px;color:#7CDAE8;padding:30px;margin-top:-5px">  </i>
                                   </span> 
                         </div>---->
                          <div class="col-sm-12 mt-5 "  >
                             <div class="row card card-body"  style=" box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);border-radius:10px" >
                                    <div class="col-sm-12" >
                                               <center>
                                                   <img src="yt.png" class="img-fluid"style="height:100px">
                                               </center>
                                    </div>
                                 <div class="col-sm-12 card-body "  >
                                     <center>  <h3><b>Upload Thumbnail</b></h3></center>
                                     <form method="post" ACTION="upload_thumbnail_process.jsp?code=<%=vcode%>"  name="uploadFile" ENCTYPE='multipart/form-data'>
                                                 <center><i class="fa fa-upload " style="font-size:70px;color:#76C5BF"></i></center><br>
                                                  <input  name="uploadFile"  required class="card card-body"  style="width:100%" id="select_file" type="file" ><br><br><br>
                                                  <input type="reset"   class="btn float-right" style="background-color:#F3246C;color:white" name="Reset"  value="Reset">
                                                  <button class="btn float-right mr-4" style="background-color:#00B488;color:white">submit</button>
...
<%
                            ...
                            out.println("<center><h1>NOT FOUND </h1></center>");
                    }
        }
   else{
