     ...
     <nav class=" sticky-top card-body bg-light"   >
               <div class="container-fluid" >
                     <div class="row"style="display:flex">
                         ...
                         <div class="col-sm-5"style="margin-top:5px;width:65%">
                          ...
                          <div class="col-sm-12 mt-5 "  >
                             <div class="row card card-body"  style=" box-shadow: 0px 8px 16px 0px rgba(0,0,0,0.2);border-radius:10px" >
                                 ...
                                 <div class="col-sm-12 card-body "  >
                                     ...
                                     <form method="post" ACTION="upload_video_process.jsp"  name="uploadFile" ENCTYPE='multipart/form-data'>
                                          
                                         
                                            <input   name="uploadFile"  required class="card card-body"  style="width:100%"id="select_file"type="file" >
                                           <br>
